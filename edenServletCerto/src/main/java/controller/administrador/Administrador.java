...
@WebServlet(name = "Administrador", value = "/HTMLS/areaRestrita/admins")
public class Administrador extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/HTMLS/areaRestrita/edenAreaRestritaPrimeiros_admins.jsp").forward(request, response);
    }
}
