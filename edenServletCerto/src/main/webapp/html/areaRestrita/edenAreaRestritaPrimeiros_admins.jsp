...
<table>
    ...
    <tr>
        ...
        <td class="icons">
            ...
            <%-- POP UP DE EDITAR  --%>
            <div class="popup">
                <form class="popdentro" method="post" action="/HTMLS/arqsJsp/areaRestrita/editarAdmin">
            ...
            <%-- POP UP DO DELETAR --%>
            <div class="popupRmv">
                <form class="popdentroRmv" method="post" action="/HTMLS/arqsJsp/administrador/rmvAdmin">
